...
{
    public class AdultMotherConfiguration : IEntityTypeConfiguration<AdultMotherModelView>
    {
        public void Configure(EntityTypeBuilder<AdultMotherModelView> builder)
        {
