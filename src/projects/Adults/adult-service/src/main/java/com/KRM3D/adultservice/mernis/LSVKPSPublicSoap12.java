package com.KRM3D.adultservice.mernis;
...
public class LSVKPSPublicSoap12
{
    ...
    public LSVKPSPublicSoap12(){}

    public LSVKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public LSVKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LSVExtendedSoapSerializationEnvelope envelope= new LSVExtendedSoapSerializationEnvelope(LSVExtendedSoapSerializationEnvelope.VER12);
