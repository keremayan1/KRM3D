...
public class INJKPSPublicSoap12
{
    ...
    public INJKPSPublicSoap12(){}

    public INJKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public INJKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        INJExtendedSoapSerializationEnvelope envelope= new INJExtendedSoapSerializationEnvelope(INJExtendedSoapSerializationEnvelope.VER12);
